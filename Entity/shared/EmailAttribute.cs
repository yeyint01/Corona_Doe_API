...
namespace Entity.shared
{
    ...
    {
        private static Regex _regex = EmailAttribute.CreateRegEx();
        ...
        public override bool IsValid(object value)
        {
            ...
            if (input == string.Empty)
                return true;
            if (EmailAttribute._regex != null)
                return input != null && EmailAttribute._regex.Match(input).Length > 0;
            int num = 0;
            ...
            return input != null && num == 1 && input[0] != '@' && input[input.Length - 1] != '@';
        }
